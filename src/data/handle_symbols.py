...
def handle_positive_emojis(text: str) -> str:
    ...
    positive_emoji_pattern = re.compile("["
        ...
        u"\U0001F60E-\U0001F60F"
        u"\U0001F617-\U0001F61C"
        u"\U0001F638-\U0001F639"
        u"\U0001F917-\U0001F918"
        u"\U0001F913"
        u"\U0001F919-\U0001F91A"
        u"\U0001F91D"
        u"\U0001F91F"
        u"\U0001F923"
        u"\U0001F44D"
...
def handle_negative_emojis(text: str) -> str:
    ...
    negative_emoji_pattern = re.compile("["
        ...
        u"\U0001F61D-\U0001F633"
        u"\U0001F635-\U0001F636"
        u"\U0001F637"
        u"\U0001F640"
        u"\U0001F641-\U0001F644"
        u"\U0001F914-\U0001F915"
        u"\U0001F910"
        u"\U0001F912"
        u"\U0001F922"
        u"\U0001F924-\U0001F92F"
        u"\U0001F44E"
        u"\U0001F4A9"
        u"🤦🏻"
        "]", flags=re.UNICODE)
...
def handle(text: str, do_sentiment: Optional[bool] = True) -> str:
    """Unify smiles and emojies by replacing them with `:)` and `:(` or `баМаОаДаЖаИ` phrases

    Parameters
    ----------
    text : str
    do_sentiment : Optional[bool], optional
        defines the need to devide emojies into positive and negative, by default False
